...
urlpatterns = [
    ...
    path("forgot-password/", views.ForgotPasswordRequestView.as_view(), name="auth-forgot-password"),
    path("forgot-password/verify/", views.ForgotPasswordVerifyView.as_view(), name="auth-forgot-password-verify"),
]
