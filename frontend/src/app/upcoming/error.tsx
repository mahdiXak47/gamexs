...
export default function UpcomingError({
  ...
  useEffect(() => {
    console.error("Upcoming route error", error);
  }, [error]);
          ...
          <div className="mx-auto grid min-h-[calc(100dvh-360px)] max-w-7xl content-center gap-8 px-4 py-16 sm:px-6">
            <div className="max-w-2xl">
              ...
              <h1 className="text-3xl font-black leading-tight sm:text-5xl">
                بازی‌های پیش‌خرید موقتاً در دسترس نیست
              </h1>
              <p className="mt-5 max-w-xl text-sm leading-8 text-blue-100 sm:text-base">
                دریافت فهرست پیش‌خریدها با خطا روبه‌رو شد. دوباره تلاش کنید یا فعلاً فهرست بازی‌ها را ببینید.
              </p>
              {error.digest && (
