...
--   # or for production:
--   kubectl exec -it <postgres-pod> -- psql -U postgres -d gamexs -c "ALTER TABLE ps5_games ADD COLUMN IF NOT EXISTS screenshot_ids TEXT[];"

ALTER TABLE ps5_games ADD COLUMN IF NOT EXISTS screenshot_ids TEXT[];
